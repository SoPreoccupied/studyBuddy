    ...
    return (
        <div className="gridDiv">
            <div className="leftColumn">
                <img className="gabbyLogo" src={require("../assets/gabbylogomedium.png")} />
            </div>
            <div className="rightColumn">
                ...
                <h2>Let's get in touch!</h2>
                    <ul id="contact">
                        ...
                        <li><a href={'mailto:gabmwalsh@gmail.com'} target="_blank">
                        ...
                        <li><a href={'https://github.com/SoPreoccupied'} target="_blank">
                        ...
                        <li><a href={'https://app.slack.com/client/T0351JZQ0/D039PJQ2T6Y'} target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-slack" viewBox="0 0 16 16">
